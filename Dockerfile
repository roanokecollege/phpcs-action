...
RUN wget -O - -q https://github.com/roanokecollege/SnakeStandard/archive/refs/tags/v${RULESET_RC_SNAKESTANDARD_VERSION}.tar.gz | tar zxv -C /tmp/rulesets --strip-components 1 --wildcards-match-slash --wildcards '*/PHPCompatibility*'
